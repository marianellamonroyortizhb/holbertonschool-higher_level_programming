...
* Technical :toolbox:: List, their methods, their similarities between with the  strings. Stacks and queues. List comprehensions. Tuples and the different with the list. Sequences, tuple packing, sequence unpacking. Statements.
---
